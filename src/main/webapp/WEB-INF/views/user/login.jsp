...
<!--[if lt IE 9]>
        <script src="</script">https://oss.maxcdn.com/html5shiv/3.7.2/html5shiv.min.js"></script>
        <script src="</script">https://oss.maxcdn.com/respond/1.4.2/respond.min.js"></script>
    <![endif]-->
</head>
